...
SERIES_OPTIONS = {'Mainlines': ['Mainlines', '54th Anniversary Series', '57th Anniversary Series', '53rd Anniversary Series', '55th Anniversary Series', '56th Anniversary Series', 'ZAMAC'], 'Premiums': ['Premiums Pop Culture', 'Premiums Boulevard', 'Premiums Fast & Furious', 'Premiums Car Culture'], 'Others': ['Track Fleet', 'Color Shifters'], 'Themed Assortments': ['Ultra Hots', 'Silver Series BMW', 'Silver Series Fast & Furious Villains', 'Silver Series National Icons', 'Luxury Sedans', 'HW Speed Graphics', 'Neon Speeders', '1/4 Mile Finals Series', 'Fast & Furious Hobbs & Shaw', 'Transformers', 'Exotics', 'Silver Series Porsche', 'Gran Turismo', 'The Hot Ones', 'Silver Series Mustang 60 Years', 'Fast & Furious Tokyo Drift']}

# Series metadata for additional information
SERIES_METADATA = {'Mainlines': {'description': 'Basic Hot Wheels cars available in most stores', 'price_range': '₹180', 'rarity': 'Common'}, 'Premiums': {'description': 'High-quality cars with premium details and packaging', 'price_range': '₹550', 'rarity': 'Rare'}, 'Others': {'description': 'Special categories and track sets', 'price_range': 'Varies', 'rarity': 'Varies'}, 'Themed Assortments': {'description': 'Mid-tier cars with better details and packaging', 'price_range': '₹300', 'rarity': 'Uncommon'}}
